...
describe Enumerable do
  ...
  describe 'test the my_all method' do
    it 'if parameter is not given and  a block is given it returns true if the condition is met' do
      expect(%w[ant bear cat].my_all? { |word| word.length >= 3 }).to be true
    end
    it 'if parameter is not given and  a block is given it returns false if the condition is not met' do
